  ...
  return (
    ...
    >
      <div className="text-center mb-16">
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-orange-600 to-red-600 mx-auto rounded-full transform transition-all duration-1000 scale-x-100"></div>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 hover:shadow-3xl transition-all duration-500">
        <div className="mb-8 transform transition-all duration-1000 translate-y-0 opacity-100">
          <h3 className="text-2xl md:text-3xl font-semibold text-gray-900 mb-6 flex items-center">
        ...
        <div className="transform transition-all duration-1000 delay-300 translate-y-0 opacity-100">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={index}
                className={`flex items-start space-x-4 p-4 rounded-xl transition-all duration-500 hover:bg-red-50 transform ${
                  visibleItems > index
